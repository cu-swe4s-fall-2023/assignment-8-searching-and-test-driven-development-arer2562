...
run "Test read_data with valid data" python get_fire.py 'Agrofood_co2_emission.csv' 1 2 3 29 'IMF_GDP.csv' ${country1} ${datadir}/${country1}.txt ${graphdir}/${country1}.png
assert_equal $file_name $( ls Argentina.png )
assert_exit_code 0
